...
if [ -f ~/.config/custom/settings/wallpaper_cache ]; then
    use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/custom/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/custom/cache/waypaper-running
cachefile="$HOME/.config/custom/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/custom/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/custom/cache/square_wallpaper.png"
rasifile="$HOME/.config/custom/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/custom/settings/blur.sh"
defaultwallpaper="$HOME/wallpaper/default.jpg"
wallpapereffect="$HOME/.config/custom/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
