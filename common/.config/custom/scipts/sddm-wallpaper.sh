...
sleep 1
clear
cache_file="$HOME/.config/custom/cache/current_wallpaper"
...
if [ -f $HOME/.config/custom/settings/sddm/theme.conf ]; then
    sddm_theme_tpl="$HOME/.config/custom/settings/sddm/theme.conf"
