...
sec=$(cat ~/.config/custom/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/custom/cache/wallpaper-automation ]; then
    touch ~/.config/custom/cache/wallpaper-automation
    ...
    rm ~/.config/custom/cache/wallpaper-automation
