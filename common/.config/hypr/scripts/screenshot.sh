...
# Screenshot Filename
source ~/.config/custom/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/custom/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/custom/settings/screenshot-editor.sh)"
...
# Rofi CMD
rofi_cmd() {
    rofi -dmenu -replace -theme /home/rik/.config/rofi/launchers/type-1/style-3.rasi -config ~/.config/rofi/config-screenshot.rasi -i -no-show-icons -l 2 -width 30 -p "Take screenshot"
}
...
# CMD
timer_cmd() {
    rofi -dmenu -replace -theme /home/rik/.config/rofi/launchers/type-1/style-3.rasi -config ~/.config/rofi/config-screenshot.rasi -i -no-show-icons -l 5 -width 30 -p "Choose timer"
}
...
# CMD
type_screenshot_cmd() {
    rofi -dmenu -replace -theme /home/rik/.config/rofi/launchers/type-1/style-3.rasi -config ~/.config/rofi/config-screenshot.rasi -i -no-show-icons -l 3 -width 30 -p "Type of screenshot"
}
...
copy_save_editor_cmd() {
    rofi -dmenu -replace -theme /home/rik/.config/rofi/launchers/type-1/style-3.rasi -config ~/.config/rofi/config-screenshot.rasi -i -no-show-icons -l 4 -width 30 -p "How to save"
}
